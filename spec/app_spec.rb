...
RSpec.describe 'Sinatra App' do
  ...
  it 'redirige correctamente a /exam en una solicitud POST' do
    post '/exam'
    ...
    expect(last_response.body).to include('MODO EXAMEN') # Verifica que la respuesta incluye contenido de index3
  end
end