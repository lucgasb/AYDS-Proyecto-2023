...
theme_sign = Theme.create(name: "signals")
theme_vel = Theme.create(name: "velocity")
theme_def = Theme.create(name: "definitions")
theme_pr = Theme.create(name: "priority")
...
question4 = Question.create(question: "En esta intersección, ¿quién tiene prioridad de paso?", theme: theme_pr)
...
question10 = Question.create(question: "En una rotonda tiene prioridad…", theme: theme_pr)
question10.save
