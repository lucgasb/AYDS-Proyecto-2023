...
theme_sign = Practice.create(category: "signals")
theme_vel = Practice.create(category: "velocity")
theme_def = Practice.create(category: "definitions")
theme_pr = Practice.create(category: "pority")

question1 = Question.create(question: "¿Qué significa esta señal?", practice_id: theme_sign)
...
question2 = Question.create(question: "¿Qué significa esta señal?", practice_id: theme_sign)
...
question3 = Question.create(question: "¿A qué se denomina incidente de tránsito o incidente vial?", image_url: nil, practice_id: theme_def)
question3.save
...
question4 = Question.create(question: "En esta intersección, ¿quién tiene prioridad de paso?", practice_id: theme_pr)
...
question5 = Question.create(question: "Cuando no hay demarcación de la senda peatonal, ¿por dónde deben cruzar los peatones?", practice_id: theme_def)
question5.save
...
question6 = Question.create(question: "¿Qué significa esta señal?", practice_id: theme_sign)
...
question7 = Question.create(question: "¿A qué se denomina “tiempo de reacción”?", practice_id: theme_def)
question7.save
...
question8 = Question.create(question: "Clasifique esta señal", practice_id: theme_sign)
...
question9 = Question.create(question: "¿Qué significa esta señal?", practice_id: theme_sign)
...
question10 = Question.create(question: "En una rotonda tiene prioridad…", practice_id: theme_pr)
question10.save
...
question11 = Question.create(question: "¿Qué significa esta Señal?", practice_id: theme_sign)
...
question12 = Question.create(question: "El cinturón de seguridad es obligatorio para:", practice_id: theme_def)
question12.save
...
question13 = Question.create(question: "¿Cuáles son los porcentajes máximos permitidos de alcoholemia para la conducción de un automóvil o camioneta?", practice_id: theme_def)
question13.save
...
question14 = Question.create(question: "¿A qué factor se deben la mayoría de siniestros víales?", practice_id: theme_def)
question14.save
Option.create(option: "Al vehicular", option2: "Al ambiental", correct: "Al humano", question: question14)

question15 = Question.create(question: "A fin de aumentar la propia seguridad y la de los demás, ¿a qué se debería poner atención durante la circulación?", practice_id: theme_def)
question15.save
...
question16 = Question.create(question: "“Cada usuario de la vía pública es responsable de una parte del tránsito.” ¿Es correcta ésta premisa?", practice_id: theme_def)
question16.save
...
question17 = Question.create(question: "Además de provocar víctimas fatales o lesionados graves, ¿Qué otras consecuencias puede generar un siniestro de tránsito?", practice_id: theme_def)
question17.save
